...
const Graph = () => {
  ...
  return (
    <div className="main-container w-full max-w-[620px] m-auto rounded-xl overflow-hidden mt-[1%] mb-[3%]">
      {!fetchToday.loading ? (
      ...
      a 15.9155 15.9155 0 0 1 0 -31.831"
                  ...
                  <path
                    ...
                    strokeDasharray={`${
                      fetchToday.data &&
                      (
                        (fetchToday.data?.active / fetchToday.data?.recovered) *
                        100
                      ).toFixed(0)
                    }, 100`}
                    d="M18 2.0845
      ...
      a 15.9155 15.9155 0 0 1 0 -31.831"
                  ...
                  <path
                    ...
                    strokeDasharray={`${
                      fetchToday.data &&
                      (
                        (fetchToday.data?.deaths / fetchToday.data?.recovered) *
                        100
                      ).toFixed(0)
                    }, 100`}
                    d="M18 2.0845
      ...
      a 15.9155 15.9155 0 0 1 0 -31.831"
            ...
            <div className="info">
              ...
              <div className="flex items-center gap-1">
                <div className="w-[10px] h-[10px] bg-[#915db1]"></div>
                <>recoverd:</>
                <span>
                  {fetchToday.data &&
