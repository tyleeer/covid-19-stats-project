    ...
    <div className="w-full bg-white text-black">
      ...
      >
        ...
        <div className="w-[30%] min-w-[320px] flex flex-col justify-center text-[2.5rem] font-semibold px-10 py-2 bg-white absolute top-[60%] left-[10%] h-[40%]">
          <span className="text-cyan-950">Coronavirus</span>
          <span className="text-cyan-950">disease</span>
          <span className="text-cyan-950">(COVID-19)</span>
        </div>
      </div>
      <div className="w-full px-2 text-black text-[3.5rem] font-semibold">
        <div className="border-b-2 border-cyan-800 text-cyan-800 capitalize">
          {overviewData.title}
        </div>
      </div>
      <div className="flex flex-col lg:flex-row w-full py-2">
        <div className="relative w-full lg:w-[70%] flex flex-col gap-2 px-4 py-2 whitespace-break-spaces">
          ...
          <p className="lg:absolute lg:bottom-4 text-[0.8rem]">
        ...
        <div className="w-full lg:w-[30%] flex flex-col gap-2 p-4 border-l-[1px] border-black">
          ...
          <div className="flex w-full ml-[10%] lg:ml-0 items-center lg:items-start gap-2 lg:flex-col">
            ...
            <p className="text-[1.2rem] text-cyan-900 sm:text-[2rem] font-semibold lg:text-center lg:w-full">
              {fetchToday.data &&
