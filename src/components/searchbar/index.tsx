...
const Searchbar = () => {
  ...
  return (
    <section className="w-full lg:w-[95%] px-2 grid grid-cols-2 gap-2 p-2 lg:flex lg:justify-between lg:items-center bg-cyan-800 text-white font-semibold m-auto rounded-t-sm">
      <div className="lg:w-[20%] flex justify-end gap-1">
        ...
        <select
          {...fieldYear}
          id="year"
          className="text-black bg-white border-2 rounded-xl"
        >
          <option>23</option>
          <option>22</option>
          <option>21</option>
      ...
      <div className="lg:w-[20%] flex gap-1">
        ...
        <select
          {...fieldMonth}
          id="month"
          className="border-2 text-black lg:w-[100px] rounded-xl bg-white px-1"
        >
      ...
      <div className="lg:w-[20%] flex gap-1 justify-end">
        ...
        <select
          {...fieldType}
          id="type"
          className="border-2 text-black lg:w-[100px] rounded-xl bg-white px-2"
        >
